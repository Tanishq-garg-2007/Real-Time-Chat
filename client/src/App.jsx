...
<video width="70%" height="auto" controls>
  ...
  Your browser does not support the video tag.
                        ...
                        <>
                        {m.message}
                        <button className='m-2 p-1' style={{backgroundColor: "#00adb5", border: "2px solid black",borderRadius:"2px"}} onClick={() => { const utterance = new SpeechSynthesisUtterance(m.message); utterance.lang = 'hi-IN';  speechSynthesis.speak(utterance); }} >Speak</button>
                        </>
                    )}
                  </div>
                );
